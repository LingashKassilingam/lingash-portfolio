...
<mat-tab-group>
  <mat-tab label="About me">
    <p>
        Hi I am Lingash Kassilingam,
        <br>
        I am a fullstack developer with 4 years 3 months of experience on developing applications with
        Angular, Spring Boot, Oracle and Google Cloud.
        <br>
        My Professional work experience is I have developed a client self service portal, 
        internal tool admin panel for 
    </p>
  </mat-tab>
...
Shades of Blue	    	#03045e, #0077b6, #00b4d8, #90e0ef, #caf0f8
...
<div class="col-6">
      <pre class="mermaid">
        ...
        service angular(logos:angular-icon)[Angular] in onprem
        service axway(server)[Axway API Gateway] in onprem
        service oracle(logos:oracle)[OracleDB] in onprem
        service java(logos:java)[Java8] in onprem
